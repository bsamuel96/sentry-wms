...
export default function PackScreen({ navigation, route }) {
  ...
  return (
    <View style={screenStyles.screen}>
      <ScreenHeader
        title={phase === 'scan_order' ? 'COMENZI DE AMBALAT' : 'PACK'}
        ...
        <FlatList
            ...
            <>
              ...
              <View style={styles.readyHeader}>
                <View style={styles.readyHeaderCopy}>
                  <Text style={styles.sectionTitle}>COMENZI DE AMBALAT</Text>
          ...
          ListEmptyComponent={readyOrdersLoading ? (
            ...
            <View style={styles.emptyState}>
              <Text style={styles.emptyTitle}>NU EXISTĂ COMENZI DE AMBALAT</Text>
          ...
          renderItem={({ item: entry }) => (
            <TouchableOpacity
              ...
              accessibilityLabel={`Deschide comanda ${entry.so_number}`}
            >
